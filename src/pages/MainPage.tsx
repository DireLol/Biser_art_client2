...
const BrownGradientBG = styled.div`
  ...
  color: white;
  padding-top: 100px;
  background: linear-gradient(180deg, rgb(115, 83, 45), rgb(217, 156, 85))
    no-repeat;
  min-width: 100vw;
  z-index: 3;
`;
    ...
    <Body>
      <Header>
        ...
        <HeaderContent>
          ...
          <AnimatedParagraph>
            <p>
              Приветствуем вас в мире великолепных украшений, где каждое изделие
              - произведение искусства. Гусынина Александра Валерьевна воплощает
              свою страсть к бисеру в уникальные украшения, которые станут
              неповторимым акцентом в вашем образе.
            </p>
          </AnimatedParagraph>
          <Gallery />
        </HeaderContent>
      ...
      <MainContent>
        <BrownGradientBG>
          <WhyChoseUs>
            ...
            <ol>
              <li>
                Индивидуальный подход: Мы создаем не только готовые изделия, но
                и<br></br> работаем по индивидуальным заказам. Воплотите свои
                идеи в жизнь вместе<br></br> с нами!
              </li>
              <li>
                Качество на первом месте: Мы используем только лучшие материалы,
                чтобы <br></br> каждое украшение было долговечным и оставалось
                красивым со временем.
              </li>
              <li>
                Широкий выбор: Наш каталог включает в себя браслеты, серьги,
                колье, и<br></br> многое другое. Найдите идеальное украшение для
                любого случая.
              </li>
            </ol>
          </WhyChoseUs>
        ...
        <Container3DContent>
          <ContainerModel>
            <Model1scene>
              <BackgroundSpline scene="https://draft.spline.design/Aj4Pp9tQtst7sXSM/scene.splinecode"></BackgroundSpline>
            </Model1scene>
          </ContainerModel>
        </Container3DContent>
        ...
        <NewAndSpeacials>
          <div className="HP">
            ...
            <p>
              Посмотрите наши последние творения и участвуйте в акциях! Наши
              <br></br> украшения - прекрасный подарок себе или вашим близким.
            </p>
          </div>
          <ContentSpecials>
            <ArrowLeftBtn onClick={handlePrevClick}>
              <img src={leftButton} alt=""></img>
            </ArrowLeftBtn>
            ...
            <ArrowRightBtn onClick={handleNextClick}>
              <img src={rightButton} alt=""></img>
            </ArrowRightBtn>
          </ContentSpecials>
          <NavLink to={SHOP_ROUTE}>
            <ButtonNavCatalog>Перейти к каталогу</ButtonNavCatalog>
          </NavLink>
        </NewAndSpeacials>
            ...
            <div>
              <IndividualOrderElem>
                <div>
                  ...
                  <p>
                    Интересует индивидуальный заказ? Свяжитесь с Гусыниной
                    Александрой прямо сейчас, чтобы начать процесс воплощения
                    ваших идей в жизнь.
                  </p>
                </div>
                <NavLink to={INDIVIDUAL_ORDER_ROUTE}>
                  <ButtonNavIndivOrder>
        ...
        <Contacts>
          <div>
            <h2>
              Контакты Гусыниной<br></br> Александры Валерьевны:
            </h2>
            <p>
              Не стесняйтесь связаться напрямую с Гусыниной Александрой для
              обсуждения заказа или получения дополнительной информации.
            </p>
            <NavLink to={ABOUTUS_ROUTE}>
              <ButtonNavAboutUs>Перейти в раздел о нас</ButtonNavAboutUs>
            </NavLink>
          </div>
          <img></img>
        </Contacts>
      ...
      <Container3DContent2>
        <ContainerModel2>
          <Model1scene2>
            <BiserModel scene="https://prod.spline.design/4roE1qjiojbMS-yw/scene.splinecode" />
          </Model1scene2>
        </ContainerModel2>
      </Container3DContent2>
      ...
      <Footer>
        <JoinCommunity>
          <ContentWrapper>
            ...
            <p>
              Следите за нашими новостями, участвуйте в обсуждениях и делитесь
              своими впечатлениями в социальных сетях.
            </p>
            <SocialLinksContainer>
              <SocialLinkColumn>
                {socialNetworks.slice(0, 3).map((network, index) => (
                  <SocialLink
                    key={index}
                    onClick={() => handleSocialLinkClick(network.link)}
                  >
        ...
        <FooterSection>
          <h4>© BiserArt 2024</h4>
          <FooterText>
            Права на все материалы, опубликованные на сайте, принадлежат их
            автору. Использование материалов возможно при наличии активной
            ссылки на источник.
          </FooterText>
          <FooterText>
